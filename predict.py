...
call(['curl', '-i', '-XPOST', 'http://140.112.18.229:32071/write?db=ntu_iot', '--data-binary', 'team8,axis=x value=' + str(int(pred_avg_xyz[0]))])
call(['curl', '-i', '-XPOST', 'http://140.112.18.229:32071/write?db=ntu_iot', '--data-binary', 'team8,axis=y value=' + str(int(pred_avg_xyz[1]))])
call(['curl', '-i', '-XPOST', 'http://140.112.18.229:32071/write?db=ntu_iot', '--data-binary', 'team8,axis=z value=' + str(int(pred_avg_xyz[2]))])
print('position sent.')
